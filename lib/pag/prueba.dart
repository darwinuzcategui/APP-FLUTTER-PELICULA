...
class Prueba extends StatefulWidget {
  ...
  static final String routerName = 'prueba';
  final prefs = new PreferenciaUsuarios();
  final String title = 'PROBANDO.URL Launcher';

  @override
  State<Prueba> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Prueba> {
  bool _hasCallSupport = false;
  Future<void> _launched;
  String _phone = '04149213235';

  @override
  void initState() {
    super.initState();
    // Check for phone call support.
    canLaunchUrl(Uri(scheme: 'tel', path: '04149213235')).then((bool result) {
      setState(() {
        _phone = '04149213235';
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              const Padding(padding: EdgeInsets.all(16.0)),
              Link(
                uri: Uri.parse('https://pub.dev/documentation/url_launcher'),
